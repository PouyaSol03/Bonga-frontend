      ...
      >
        ...
        >
          <div className="grid h-14 w-14 place-items-center rounded-2xl border-2 border-current bg-white shadow-[0_8px_20px_rgba(0,72,196,0.12)] min-[390px]:h-16 min-[390px]:w-16">
            <Typography as="span" variant="body" size="medium" weight="regular" className="h-7 w-7 rounded-lg border-2 border-current border-t-0 min-[390px]:h-8 min-[390px]:w-8" />
          </div>
          <Typography as="span" variant="body" size="medium" weight="regular" className="absolute left-5 top-5 h-3 w-3 rounded-full bg-[#11a366]" />
          <Typography as="span" variant="body" size="medium" weight="regular" className="absolute bottom-6 right-4 h-2.5 w-2.5 rounded-full bg-[#ffb100]" />
        </div>
        ...
        <Typography as="p" variant="body" size="medium" weight="regular" className="m-0 mt-3 text-sm font-normal leading-6 text-[#4d4d4d]">
          {message}
        </Typography>
