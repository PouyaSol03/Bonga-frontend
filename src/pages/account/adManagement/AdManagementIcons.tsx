  ...
  if (icon === "online") {
    return (
      <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        <path d="M12 10.45C13.5112 10.45 14.75 11.676 14.75 13.2C14.75 14.7239 13.5112 15.95 12 15.95C10.4888 15.95 9.25 14.7239 9.25 13.2C9.25 11.688 10.4881 10.45 12 10.45Z" fill="url(#paint1_radial_1513_2356)" stroke="#F59C0A" strokeWidth="0.5" />
        <defs>
