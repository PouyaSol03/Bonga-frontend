...
export function IndependentConsultantFileBadgePage() {
  return <IndependentConsultantBadgeDetailsPage badgeKey="file" />;
}

export function IndependentConsultantMagnetBadgePage() {
  return <IndependentConsultantBadgeDetailsPage badgeKey="magnet" />;
}
...
function IndependentConsultantBadgeDetailsPage({ badgeKey }: { badgeKey: BadgeKey }) {
