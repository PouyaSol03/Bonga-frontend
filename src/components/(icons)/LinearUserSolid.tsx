...
const LinearUserSolid: React.FC<LinearUserSolidProps> = ({
  active: _active,
  size,
  solidColor,
  solidOpacity = 0.16,
  ...
  const hasSolid = Boolean(solidColor);
