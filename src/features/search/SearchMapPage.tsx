...
const filterableParamKeys = [
  ...
  "opening_count_min",
  "opening_count_max",
  "space_type", "rental_period", "view_type", "check_in_time", "check_out_time",
...
const featureFilterParamKeys = new Set([
  ...
  "space_type", "rental_period", "view_type", "check_in_time", "check_out_time", "min_stay_days", "min_stay_days_min", "min_stay_days_max",
