...
} from "../../search/api/saved-search.hooks";
import { useQuickAdvertisementSearchQuery } from "../api/quick-advertisement-search.hooks";
...
import type { SearchHistoryItem } from "../../search/api/search-history.service";
import { getStoredAuthSession } from "../../../shared/auth/auth-storage";
import type { SavedSearchItem } from "../../search/api/saved-search.service";
import type { QuickAdvertisementSearchItem } from "../api/quick-advertisement-search.service";
