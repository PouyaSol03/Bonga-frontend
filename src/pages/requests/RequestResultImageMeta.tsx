      ...
      <ImageMetaIcon
        icon={
          <span className="inline-flex items-center gap-0.5">
            ...
            <span className="text-[10px] font-medium leading-none">{imageCount}</span>
          </span>
        }
      />
...
function ImageMetaIcon({ icon }: { icon: ReactNode }) {
  return (
    <span className="grid h-7 min-w-7 place-items-center border-l border-white/30 px-1 last:border-l-0">
      {icon}
    </span>
  );
}
