...
import { normalizeAuthRoleSlug, type AuthSession } from '../../shared/auth/auth-storage'
...
const LoginPhonePage = lazyNamed(() => import('../../features/auth/LoginPhonePage'), 'LoginPhonePage')
const LoginRequiredPage = lazyNamed(() => import('../../features/auth/LoginRequiredPage'), 'LoginRequiredPage')
const LoginVerifyPage = lazyNamed(() => import('../../features/auth/LoginVerifyPage'), 'LoginVerifyPage')
const PaymentVerifyPage = lazyNamed(() => import('../../features/payments/PaymentVerifyPage'), 'PaymentVerifyPage')
const AccessDeniedPage = lazyNamed(() => import('../../features/system/AccessDeniedPage'), 'AccessDeniedPage')
...
const CrmUsersPage = lazyNamed(() => import('../../features/crm/routes/CrmUsersPage'), 'CrmUsersPage')
const CrmConsultantsPage = lazyNamed(() => import('../../features/crm/routes/CrmConsultantsPage'), 'CrmConsultantsPage')
const CrmAgenciesPage = lazyNamed(() => import('../../features/crm/routes/CrmAgenciesPage'), 'CrmAgenciesPage')
const CrmCategoriesPage = lazyNamed(() => import('../../features/crm/routes/CrmCategoriesPage'), 'CrmCategoriesPage')
const CrmLocationsPage = lazyNamed(() => import('../../features/crm/routes/CrmLocationsPage'), 'CrmLocationsPage')
const CrmLocationMapPage = lazyNamed(() => import('../../features/crm/routes/CrmLocationMapPage'), 'CrmLocationMapPage')
const CrmFormsPage = lazyNamed(() => import('../../features/crm/routes/CrmFormsPage'), 'CrmFormsPage')
const CrmPackagesPage = lazyNamed(() => import('../../features/crm/routes/CrmPackagesPage'), 'CrmPackagesPage')
const CrmPaymentsPage = lazyNamed(() => import('../../features/crm/routes/CrmPaymentsPage'), 'CrmPaymentsPage')
const CrmCostsPage = lazyNamed(() => import('../../features/crm/routes/CrmCostsPage'), 'CrmCostsPage')
const CrmReportsPage = lazyNamed(() => import('../../features/crm/routes/CrmReportsPage'), 'CrmReportsPage')
...
const AccountBookmarksPage = lazyNamed(() => import('../../features/account/routes/AccountBookmarksPage'), 'AccountBookmarksPage')
const AccountDeleteUserPage = lazyNamed(() => import('../../features/account/AccountDeleteUserPage'), 'AccountDeleteUserPage')
const AccountIdentityPage = lazyNamed(() => import('../../features/account/routes/AccountIdentityPage'), 'AccountIdentityPage')
const AccountMyAdsEmptyPage = lazyNamed(() => import('../../features/account/routes/AccountMyAdsEmptyPage'), 'AccountMyAdsEmptyPage')
const AccountMyAdsPage = lazyNamed(() => import('../../features/account/routes/AccountMyAdsPage'), 'AccountMyAdsPage')
const AccountNotesPage = lazyNamed(() => import('../../features/account/routes/AccountNotesPage'), 'AccountNotesPage')
const AccountProfilePage = lazyNamed(() => import('../../features/account/routes/AccountProfilePage'), 'AccountProfilePage')
const AccountRecentViewsPage = lazyNamed(() => import('../../features/account/routes/AccountRecentViewsPage'), 'AccountRecentViewsPage')
const AccountRequestsPage = lazyNamed(() => import('../../features/account/routes/AccountRequestsPage'), 'AccountRequestsPage')
const AccountSupportPage = lazyNamed(() => import('../../features/account/routes/AccountSupportPage'), 'AccountSupportPage')
const AccountSupportChatPage = lazyNamed(() => import('../../features/account/routes/AccountSupportChatPage'), 'AccountSupportChatPage')
const AccountSupportNewChatPage = lazyNamed(() => import('../../features/account/routes/AccountSupportNewChatPage'), 'AccountSupportNewChatPage')
const AccountSupportRequestsPage = lazyNamed(() => import('../../features/account/routes/AccountSupportRequestsPage'), 'AccountSupportRequestsPage')
const AccountSupportNewRequestPage = lazyNamed(() => import('../../features/account/routes/AccountSupportNewRequestPage'), 'AccountSupportNewRequestPage')
const AccountSupportFaqPage = lazyNamed(() => import('../../features/account/AccountSupportFaqPage'), 'AccountSupportFaqPage')
const AccountWalletHistoryPage = lazyNamed(() => import('../../features/account/routes/AccountWalletHistoryPage'), 'AccountWalletHistoryPage')
const AccountWalletPage = lazyNamed(() => import('../../features/account/routes/AccountWalletPage'), 'AccountWalletPage')
const IndependentConsultantRankingPage = lazyNamed(() => import('../../features/account/IndependentConsultantRankingPage'), 'IndependentConsultantRankingPage')
const IndependentConsultantRankingLevelsPage = lazyNamed(() => import('../../features/account/IndependentConsultantRankingLevelsPage'), 'IndependentConsultantRankingLevelsPage')
const IndependentConsultantBadgesGuidePage = lazyNamed(() => import('../../features/account/IndependentConsultantBadgesGuidePage'), 'IndependentConsultantBadgesGuidePage')
const IndependentConsultantFileBadgePage = lazyNamed(() => import('../../features/account/routes/IndependentConsultantFileBadgePage'), 'IndependentConsultantFileBadgePage')
const IndependentConsultantMagnetBadgePage = lazyNamed(() => import('../../features/account/routes/IndependentConsultantMagnetBadgePage'), 'IndependentConsultantMagnetBadgePage')
const IndependentConsultantResponseBadgePage = lazyNamed(() => import('../../features/account/routes/IndependentConsultantResponseBadgePage'), 'IndependentConsultantResponseBadgePage')
const IndependentConsultantTimeBadgePage = lazyNamed(() => import('../../features/account/routes/IndependentConsultantTimeBadgePage'), 'IndependentConsultantTimeBadgePage')
const IndependentConsultantAdManagementPage = lazyNamed(() => import('../../features/account/IndependentConsultantAdManagementPage'), 'IndependentConsultantAdManagementPage')
...
const AdDeleteReasonPage = lazyNamed(() => import('../../features/account/adManagement/AdDeleteReasonPage'), 'AdDeleteReasonPage')
const IndependentConsultantAdSearchPage = lazyNamed(() => import('../../features/account/adManagement/IndependentConsultantAdSearchPage'), 'IndependentConsultantAdSearchPage')
const IndependentConsultantAdStatisticsDetailsPage = lazyNamed(() => import('../../features/account/adManagement/IndependentConsultantAdStatisticsDetailsPage'), 'IndependentConsultantAdStatisticsDetailsPage')
const IndependentConsultantAdStatisticsPage = lazyNamed(() => import('../../features/account/adManagement/IndependentConsultantAdStatisticsPage'), 'IndependentConsultantAdStatisticsPage')
const IndependentConsultantCreditPackagesPage = lazyNamed(() => import('../../features/account/routes/IndependentConsultantCreditPackagesPage'), 'IndependentConsultantCreditPackagesPage')
const IndependentConsultantPanelCreditBonusPage = lazyNamed(() => import('../../features/account/routes/IndependentConsultantPanelCreditBonusPage'), 'IndependentConsultantPanelCreditBonusPage')
const IndependentConsultantPanelCreditPage = lazyNamed(() => import('../../features/account/routes/IndependentConsultantPanelCreditPage'), 'IndependentConsultantPanelCreditPage')
const IndependentConsultantCreditHistoryPage = lazyNamed(() => import('../../features/account/credit/IndependentConsultantCreditHistoryPage'), 'IndependentConsultantCreditHistoryPage')
const DashboardAgencyPage = lazyNamed(() => import('../../features/dashboard/DashboardHomePage'), 'DashboardAgencyPage')
const DashboardAgentPage = lazyNamed(() => import('../../features/dashboard/AgentProfilePage'), 'AgentProfilePage')
const DashboardAgencyPreviewPage = lazyNamed(() => import('../../features/dashboard/AgencyPreviewPage'), 'AgencyPreviewPage')
const DashboardAgencyQrCodePage = lazyNamed(() => import('../../features/dashboard/AgencyPreviewPage'), 'AgencyQrCodePage')
const DashboardAddConsultantPage = lazyNamed(() => import('../../features/dashboard/DashboardHomePage'), 'DashboardAddConsultantPage')
const DashboardConsultantEditPage = lazyNamed(() => import('../../features/dashboard/DashboardHomePage'), 'DashboardConsultantEditPage')
const DashboardConsultantInfoPage = lazyNamed(() => import('../../features/dashboard/DashboardHomePage'), 'DashboardConsultantInfoPage')
const DashboardConsultantRemovePage = lazyNamed(() => import('../../features/dashboard/DashboardHomePage'), 'DashboardConsultantRemovePage')
const DashboardHomePage = lazyNamed(() => import('../../features/dashboard/DashboardHomePage'), 'DashboardHomePage')
const DashboardPaymentsPage = lazyNamed(() => import('../../features/dashboard/DashboardHomePage'), 'DashboardPaymentsPage')
const DashboardRankingPage = lazyNamed(() => import('../../features/dashboard/DashboardRankingPage'), 'DashboardRankingPage')
const DashboardBadgesGuidePage = lazyNamed(() => import('../../features/dashboard/DashboardBadgesGuidePage'), 'DashboardBadgesGuidePage')
const DashboardRankingLevelsGuidePage = lazyNamed(() => import('../../features/dashboard/DashboardRankingLevelsGuidePage'), 'DashboardRankingLevelsGuidePage')
const DashboardRecordHolderBadgePage = lazyNamed(() => import('../../features/dashboard/DashboardBadgeDetailsPage'), 'DashboardRecordHolderBadgePage')
const DashboardGoldenTeamBadgePage = lazyNamed(() => import('../../features/dashboard/DashboardBadgeDetailsPage'), 'DashboardGoldenTeamBadgePage')
const DashboardPopularBadgePage = lazyNamed(() => import('../../features/dashboard/DashboardBadgeDetailsPage'), 'DashboardPopularBadgePage')
...
const UserChatHomePage = lazyNamed(() => import('../../features/chat/UserChatHomePage'), 'UserChatHomePage')
const UserChatBulkDeletePage = lazyNamed(() => import('../../features/chat/UserChatHomePage'), 'UserChatBulkDeletePage')
const UserChatResponseTimePage = lazyNamed(() => import('../../features/chat/UserChatHomePage'), 'UserChatResponseTimePage')
const UserChatRenamePage = lazyNamed(() => import('../../features/chat/UserChatHomePage'), 'UserChatRenamePage')
const ConsultantsDirectoryPage = lazyNamed(() => import('../../features/consultants/ConsultantsDirectoryPage'), 'ConsultantsDirectoryPage')
const ConsultantsNeighborhoodPage = lazyNamed(
  () => import('../../features/consultants/ConsultantsNeighborhoodPage'),
  'ConsultantsNeighborhoodPage',
)
const AgencyBusinessCreationPage = lazyNamed(() => import('../../features/account/routes/AgencyBusinessCreationPage'), 'AgencyBusinessCreationPage')
const AgencyNeighborhoodSelectionPage = lazyNamed(() => import('../../features/account/routes/AgencyNeighborhoodSelectionPage'), 'AgencyNeighborhoodSelectionPage')
