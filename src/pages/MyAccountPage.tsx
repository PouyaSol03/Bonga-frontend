...
function AccountIcon({
  ...
  return (
    ...
    >
      ...
      {name === "bookmark" ?
        <>
          <path xmlns="http://www.w3.org/2000/svg" d="M12 17L19 21V5C19 4 18 3 17 3H7C6 3 5 4 5 5V21L12 17Z" stroke="#4D4D4D" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        </>
        : null}
      {name === "building" ? (
        <>
          <path xmlns="http://www.w3.org/2000/svg" d="M8.4 21V9.3C8.4 8.80295 8.80295 8.4 9.3 8.4H15.6C16.0971 8.4 16.5 8.80295 16.5 9.3V21M11.55 12.0016H13.35M11.55 14.7008H13.35M11.55 17.4016L13.35 17.4M3.9 20.9947V12.8947C3.9 12.3977 4.30295 11.9947 4.8 11.9947H8.4M21 20.9895L3 21M12.9 8.37306V3L20.1 5.75523V21" stroke="#4D4D4D" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        </>
      ) : null}
      {name === "dashboard" ? (
        <>
      ...
      {name === "log_out" ? (
        <>
          <path xmlns="http://www.w3.org/2000/svg" d="M6.66667 7.05002C5.03 8.53319 4 10.501 4 12.9C4 17.3735 7.58172 21 12 21C16.4183 21 20 17.3735 20 12.9C20 10.501 18.97 8.53319 17.3333 7.05002M9.77778 5.25001L12 3L14.2222 5.25001M12 12V3.5479" stroke="#4D4D4D" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        </>
      ) : null}
      {name === "note" ? (
        <>
      ...
      {name === "request" ? (
        <>
          <path xmlns="http://www.w3.org/2000/svg" d="M21 15V6C21 4.89543 20.1046 4 19 4H5C3.89543 4 3 4.89543 3 6V20C3 21.1046 3.89543 22 5 22H11M7 9L17 9M7 13H12M7 17H7.01M21 19.5H15M16.5 22L14 19.5L16.5 17" stroke="#4D4D4D" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        </>
      ) : null}
      {name === "setting" ? (
        <>
      ...
      {name === "tag" ? (
        <>
          <path xmlns="http://www.w3.org/2000/svg" d="M7.83617 13.3498L10.6529 16.1664M17.712 7.69446C17.712 6.91665 17.0814 6.28612 16.3037 6.28612C15.5259 6.28612 14.8953 6.91665 14.8953 7.69446C14.8953 8.47226 15.5259 9.10279 16.3037 9.10279C17.0814 9.10279 17.712 8.47226 17.712 7.69446ZM10.2833 20.45L3.54999 13.7167C2.81668 12.9834 2.81667 11.7944 3.54999 11.0611L11.0611 3.54999C11.4133 3.19783 11.8909 3 12.3889 3H21V11.6111C21 12.1091 20.8022 12.5867 20.45 12.9389L12.9389 20.45C12.2056 21.1833 11.0166 21.1833 10.2833 20.45Z" stroke="#4D4D4D" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        </>
      ) : null}
      {name === "user" ? (
        <>
          <path d="M13 14H11C7.13401 14 4 17.134 4 21H20C20 17.134 16.866 14 13 14Z" stroke={color ? color : '#4D4D4D'} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M12 11C14.2091 11 16 9.20914 16 7C16 4.79086 14.2091 3 12 3C9.79086 3 8 4.79086 8 7C8 9.20914 9.79086 11 12 11Z" stroke={color ? color : '#4D4D4D'} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        </>
      ) : null}
      {name === "wallet" ? (
        <>
